...
The_altitude_the_shuttle_reaches = 0
...
while Number_of_astronauts_aboard < 1 or Number_of_astronauts_aboard > 7:
    Number_of_astronauts_aboard = int(input("Enter the number of astronaut: "))
...
while Starting_fuel_level -100*Number_of_astronauts_aboard >= 0:
   The_altitude_the_shuttle_reaches += 50
...
# print(f"The shuttle gained an altitude of {The_altitude_the_shuttle_reaches} km and has {Starting_fuel_level} kg of fuel left.")
# If the altitude is 2000 km or higher, add “Orbit achieved!” Otherwise add, “Failed to reach orbit.”
if The_altitude_the_shuttle_reaches >= 2000:
    ending =  "Orbit achieved!"
else:
     ending =  "Failed to reach orbit"
print("The shuttle gained an altitude of" , The_altitude_the_shuttle_reaches, "km and has", Starting_fuel_level, "kg of fuel left." ,ending)